...
namespace Quick_CRM {
    ...
    public partial class CRMDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerRow AddCustomerRow(string Name, string Email, string Phone) {
...
namespace Quick_CRM.CRMDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (([CustomerId] = @Original_CustomerId) AND ([Name] = @Original_Name) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([Name], [Email], [Phone]) VALUES (@Name, @Email, @P" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [Name] = @Name, [Email] = @Email, [Phone] = @Phone WHERE (([CustomerId] = @Original_CustomerId) AND ([Name] = @Original_Name) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT CustomerId, Name, Email, Phone FROM Customer WHERE (CustomerId = @CustomerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Quick_CRM.Properties.Settings.Default.CRMConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, Name, Email, Phone FROM dbo.Customer";
        ...
        public virtual int Delete(int Original_CustomerId, string Original_Name, string Original_Email, string Original_Phone) {
        ...
        public virtual int Update(string Name, string Email, string Phone, int Original_CustomerId, string Original_Name, string Original_Email, string Original_Phone, int CustomerId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string Phone, int Original_CustomerId, string Original_Name, string Original_Email, string Original_Phone) {
            return this.Update(Name, Email, Phone, Original_CustomerId, Original_Name, Original_Email, Original_Phone, Original_CustomerId);
        }
    }
